...
const BootSequence = ({ onComplete }) => {
  ...
  const styles = {
    ...
    line1: { color: '#F6C85F', fontSize: '1.2rem', fontWeight: 'bold' },
    lineDim: { fontSize: '0.9rem', color: 'rgba(255,255,255,0.6)' },
    lineReady: { color: '#4ade80', fontWeight: 'bold', marginTop: '10px' },
