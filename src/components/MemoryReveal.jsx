    ...
    <InteractionGate active={animDone} sceneKey="MEMORY_REVEAL" buttonText="[ XEM ĐIỀU BẤT NGỜ CUỐI CÙNG ]" onInteract={handleInteract}>
      <div ref={containerRef} style={styles.wrapper}>
        <div style={styles.header}>
          <div ref={titleRef} style={styles.title}>KHOẢNH KHẮC BẤT TỬ...</div>
          <div ref={subtitleRef} style={styles.subtitle}>Mấy tấm này không đem đi triển lãm hơi phí 😂</div>
        </div>
...
const styles = {
  ...
  card: {
    backgroundColor: '#fff',
    padding: 'clamp(8px, 2vw, 12px) clamp(8px, 2vw, 12px) clamp(16px, 3vw, 24px) clamp(8px, 2vw, 12px)',
    borderRadius: '8px',
